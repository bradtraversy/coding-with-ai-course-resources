...
Now we have a full plan. Look it over and ask for clarification if you do not understand something. For instance, you may want to ask:

```text
Does implementing this plan take any changes to the structure of the database?
```

The answer should be no if you have followed everything I have done.
