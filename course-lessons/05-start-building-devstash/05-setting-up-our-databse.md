...
What I like to do is use a production and a development branch. Each have their own connection strings. We add the dev one in our local env file and we add the prod one in Vercel or wherever you deploy.
