...
Now we need some pagination. Let's create the file `context/features/pagination-spec.md` and add the following:
...
- Dashboard limits: DASHBOARD_COLLECTIONS_LIMIT = 6, DASHBOARD_RECENT_ITEMS_LIMIT = 20
```

One it all looks good, review and complete the feature.
