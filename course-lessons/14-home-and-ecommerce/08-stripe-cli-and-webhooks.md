...
You will probably see a message that says you have not configured API keys. Press **Enter** to open your browser and authenticate with Stripe. Then click **Allow Access** for your sandbox.
...
Now we are ready to test this in the next lesson.
