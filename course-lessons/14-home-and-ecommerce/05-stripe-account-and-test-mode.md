...
```text
STRIPE_SECRET_KEY="ADD_VALUE"
STRIPE_PUBLISHABLE_KEY="ADD_VALUE"
STRIPE_WEBHOOK_SECRET="ADD_VALUE"
STRIPE_PRICE_ID_MONTHLY="ADD_VALUE"
STRIPE_PRICE_ID_YEARLY="ADD_VALUE"
```
