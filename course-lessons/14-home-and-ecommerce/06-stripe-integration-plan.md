...
First, let's create a new file to have the research command create the implementation documentation for us. Create a new file at `/docs/research/stripe-integration-research.md` and copy the content from the course file `/research-files/stripe-integration-research.md`.
